...
public class SliderList {
    ...
    public void setUpDB(){
        ...
        database.execSQL("INSERT INTO workouts (image,favoritesImage, athleteName, requiresPremium, isFavorite, link, tagNum) VALUES ('" + zlatanLocation + "','"+zlatanFavoriteLocation+"','Zlatan  Ibrahim.','true', 'false','https://www.fourfourtwo.com/performance/training/zlatan-workout',3)");
        database.execSQL("INSERT INTO workouts (image,favoritesImage, athleteName, requiresPremium, isFavorite, link, tagNum) VALUES ('" + judgeLocation + "','"+judgeFavoriteLocation+"','Aaron Judge','true', 'false','https://www.mensjournal.com/sports/8-ways-aaron-judge-trains-mlb-domination/6-yoga-and-pilates/',4)");
        database.execSQL("INSERT INTO workouts (image,favoritesImage, athleteName, requiresPremium, isFavorite, link, tagNum) VALUES ('" + ronaldoLocation + "','"+ronaldoFavoriteLocation+"','Cristiano Ronaldo','true', 'false','https://manofmany.com/lifestyle/fitness/cristiano-ronaldos-football-diet-workout-plan',5)");
        database.execSQL("INSERT INTO workouts (image,favoritesImage, athleteName, requiresPremium, isFavorite, link, tagNum) VALUES ('" + ronaldoLocation + "','"+ronaldoFavoriteLocation+"','James Harrison','true', 'false','https://www.borntoworkout.com/james-harrison-workout-routine-diet-plan-body-statistics/',6)");
        database.execSQL("INSERT INTO workouts (image,favoritesImage, athleteName, requiresPremium, isFavorite, link, tagNum) VALUES ('" + ronaldoLocation + "','"+ronaldoFavoriteLocation+"','Paul George','true', 'false','https://www.health-yogi.com/paul-george-diet-plan-workout-routine/',7)");
        //Diets Table
        ...
        database.execSQL("INSERT INTO diets (image,favoritesImage, athleteName, requiresPremium, isFavorite, link, tagNum) VALUES ('" + ronaldoLocation + "','"+ronaldoFavoriteLocation+"','C. Ronaldo','false', 'false','https://manofmany.com/lifestyle/fitness/cristiano-ronaldos-football-diet-workout-plan', 0)");
